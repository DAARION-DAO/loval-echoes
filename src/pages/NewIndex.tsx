...
const dashboardLocals = {
  uk: {
    ...
    deviceStatusLoading: "Перевіряємо статус",
    deviceStatusInviteCreated: "Код готовий",
    deviceStatusConnected: "Пристрій підключено",
    deviceStatusNeedsAttention: "Потрібна увага",
    deviceStatusBlocked: "Підключення готується",
    ...
    deviceBackendReady: "MicroDAO готовий видати код підключення пристрою.",
    deviceBackendPending: "Pairing-код зʼявиться після активації backend-сервісу.",
    deviceInviteReady: "Код підключення готовий для DAARION Edge.",
    deviceDashboardAvailable: "Dashboard не вимагає підключеного пристрою.",
    devicePrimaryCta: "Підготувати пристрій",
    deviceSetupRequiredCta: "Очікує активації",
    deviceContinueSetupCta: "Відкрити код",
    deviceRefreshCta: "Оновити",
    deviceCopyCodeCta: "Скопіювати код",
    deviceCodeCopied: "Код підключення скопійовано.",
    deviceCodeLabel: "Код підключення пристрою",
    deviceExpiresLabel: "Діє до",
    deviceHelper: "Це не код запрошення до MicroDAO. Використайте цей код у DAARION Edge для підключення пристрою.",
    deviceLoadError: "Не вдалося завантажити статус пристрою.",
    deviceCreateError: "Не вдалося створити код підключення.",
    deviceBackendNotConfigured: "Підключення пристрою ще готується. Dashboard доступний, а pairing-код зʼявиться після активації backend-сервісу.",
  },
  en: {
    ...
    deviceStatusLoading: "Checking status",
    deviceStatusInviteCreated: "Code ready",
    deviceStatusConnected: "Device connected",
    deviceStatusNeedsAttention: "Needs attention",
    deviceStatusBlocked: "Connection being prepared",
    ...
    deviceBackendReady: "MicroDAO is ready to issue a device connection code.",
    deviceBackendPending: "The pairing code will appear after the backend service is activated.",
    deviceInviteReady: "Connection code is ready for DAARION Edge.",
    deviceDashboardAvailable: "Dashboard access does not require a connected device.",
    devicePrimaryCta: "Prepare device",
    deviceSetupRequiredCta: "Activation pending",
    deviceContinueSetupCta: "Open code",
    deviceRefreshCta: "Refresh",
    deviceCopyCodeCta: "Copy code",
    deviceCodeCopied: "Device connection code copied.",
    deviceCodeLabel: "Device connection code",
    deviceExpiresLabel: "Expires",
    deviceHelper: "This is not a MicroDAO invite code. Use this code in DAARION Edge to connect the device.",
    deviceLoadError: "Could not load device status.",
    deviceCreateError: "Could not create device connection code.",
    deviceBackendNotConfigured: "Device connection is being prepared. Dashboard remains available, and the pairing code will appear after the backend service is activated.",
  },
  ru: {
    ...
    deviceStatusLoading: "Проверяем статус",
    deviceStatusInviteCreated: "Код готов",
    deviceStatusConnected: "Устройство подключено",
    deviceStatusNeedsAttention: "Требует внимания",
    deviceStatusBlocked: "Подключение готовится",
    ...
    deviceBackendReady: "MicroDAO готов выдать код подключения устройства.",
    deviceBackendPending: "Pairing-код появится после активации backend-сервиса.",
    deviceInviteReady: "Код подключения готов для DAARION Edge.",
    deviceDashboardAvailable: "Dashboard не требует подключенного устройства.",
    devicePrimaryCta: "Подготовить устройство",
    deviceSetupRequiredCta: "Ожидает активации",
    deviceContinueSetupCta: "Открыть код",
    deviceRefreshCta: "Обновить",
    deviceCopyCodeCta: "Скопировать код",
    deviceCodeCopied: "Код подключения скопирован.",
    deviceCodeLabel: "Код подключения устройства",
    deviceExpiresLabel: "Действует до",
    deviceHelper: "Это не код приглашения в MicroDAO. Используйте этот код в DAARION Edge для подключения устройства.",
    deviceLoadError: "Не удалось загрузить статус устройства.",
    deviceCreateError: "Не удалось создать код подключения.",
    deviceBackendNotConfigured: "Подключение устройства еще готовится. Dashboard доступен, а pairing-код появится после активации backend-сервиса.",
  },
  es: {
    ...
    deviceStatusLoading: "Comprobando estado",
    deviceStatusInviteCreated: "Código listo",
    deviceStatusConnected: "Dispositivo conectado",
    deviceStatusNeedsAttention: "Requiere atención",
    deviceStatusBlocked: "Conexión en preparación",
    ...
    deviceBackendReady: "MicroDAO está listo para emitir un código de conexión del dispositivo.",
    deviceBackendPending: "El código de pairing aparecerá después de activar el servicio backend.",
    deviceInviteReady: "El código de conexión está listo para DAARION Edge.",
    deviceDashboardAvailable: "El Dashboard no requiere un dispositivo conectado.",
    devicePrimaryCta: "Preparar dispositivo",
    deviceSetupRequiredCta: "Activación pendiente",
    deviceContinueSetupCta: "Abrir código",
    deviceRefreshCta: "Actualizar",
    deviceCopyCodeCta: "Copiar código",
    deviceCodeCopied: "Código de conexión copiado.",
    deviceCodeLabel: "Código de conexión del dispositivo",
    deviceExpiresLabel: "Expira",
    deviceHelper: "Esto no es un código de invitación a MicroDAO. Usa este código en DAARION Edge para conectar el dispositivo.",
    deviceLoadError: "No se pudo cargar el estado del dispositivo.",
    deviceCreateError: "No se pudo crear el código de conexión.",
    deviceBackendNotConfigured: "La conexión del dispositivo aún se está preparando. El Dashboard sigue disponible y el código de pairing aparecerá después de activar el servicio backend.",
  }
};
        ...
        {activeCommunityId && (
          <DeviceConnectionCard
            ...
            labels={{
              ...
              statusLoading: dl.deviceStatusLoading,
              statusInviteCreated: dl.deviceStatusInviteCreated,
              statusConnected: dl.deviceStatusConnected,
              statusNeedsAttention: dl.deviceStatusNeedsAttention,
              statusBlocked: dl.deviceStatusBlocked,
              description: dl.deviceDescription,
              contextReady: dl.deviceContextReady,
              backendReady: dl.deviceBackendReady,
              backendPending: dl.deviceBackendPending,
              inviteReady: dl.deviceInviteReady,
              dashboardAvailable: dl.deviceDashboardAvailable,
              primaryCta: dl.devicePrimaryCta,
              setupRequiredCta: dl.deviceSetupRequiredCta,
              continueSetupCta: dl.deviceContinueSetupCta,
              refreshCta: dl.deviceRefreshCta,
              copyCodeCta: dl.deviceCopyCodeCta,
              codeCopied: dl.deviceCodeCopied,
              codeLabel: dl.deviceCodeLabel,
              expiresLabel: dl.deviceExpiresLabel,
              helper: dl.deviceHelper,
              loadError: dl.deviceLoadError,
              createError: dl.deviceCreateError,
              backendNotConfigured: dl.deviceBackendNotConfigured,
            }}
          />
        )}
