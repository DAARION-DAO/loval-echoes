...
const dashboardLocals = {
  uk: {
    ...
    deviceStatusBlocked: "Потрібне налаштування",
    ...
    deviceBackendPending: "Підключення пристрою ще готується.",
    ...
    deviceBackendNotConfigured: "Підключення пристрою ще не налаштоване. Спробуйте пізніше.",
  },
  en: {
    ...
    deviceStatusBlocked: "Setup required",
    ...
    deviceBackendPending: "Device connection setup is still being prepared.",
    ...
    deviceBackendNotConfigured: "Device connection is not configured yet. Try again later.",
  },
  ru: {
    ...
    deviceStatusBlocked: "Нужна настройка",
    ...
    deviceBackendPending: "Подключение устройства еще готовится.",
    ...
    deviceBackendNotConfigured: "Подключение устройства еще не настроено. Попробуйте позже.",
  },
  es: {
    ...
    deviceStatusBlocked: "Configuración requerida",
    ...
    deviceBackendPending: "La conexión del dispositivo aún se está preparando.",
    ...
    deviceBackendNotConfigured: "La conexión del dispositivo aún no está configurada. Inténtalo más tarde.",
  }
};
