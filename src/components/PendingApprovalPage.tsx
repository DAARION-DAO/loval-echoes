      ...
      <div className="max-w-md w-full space-y-6">
        <Card className="shadow-elegant border-border/80 bg-card/70 backdrop-blur-md">
          <CardHeader className="text-center pb-4">
            ...
            <CardTitle className="text-2xl font-bold tracking-tight text-foreground">Заявку отримано</CardTitle>
            <CardDescription className="text-muted-foreground mt-2 leading-relaxed text-sm">
              MicroDAO відкриває доступ поступово. Ми перевіримо заявку та повідомимо, коли простір буде активовано.
            </CardDescription>
          </CardHeader>
            ...
            <div className="rounded-xl border bg-muted/20 p-4 space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <div className="space-y-0.5">
                  <div className="text-[11px] text-muted-foreground uppercase font-semibold tracking-wider">Ваш акаунт</div>
