...
export const translations: Record<Language, Translations> = {
  uk: {
    ...
    nav: {
      ...
      installClient: 'Підключити пристрій',
    ...
    landing: {
      ...
      whatIsMicroDAODesc: 'MicroDAO — це жива операційна система для невеликих спільнот, побудована навколо агентів штучного інтелекту. Вона інтегрує агентів пам\'яті та координації з вашою базою знань та задачами. Платформа підтримує приватних агентів, майбутній microDAO token layer і підключення пристроїв для локальних можливостей, коли вони потрібні.',
    ...
    onboarding: {
      ...
      errorLimitTitle: 'Ранній доступ обмежено',
      errorLimitDesc: 'Ранній доступ тимчасово обмежено. Ми відкриваємо нові місця поступово. Залиште заявку або спробуйте пізніше.',
    ...
    clientInstall: {
      ...
      sideload: 'Sideload',
      comingSoon: 'Скоро',
      archLayersTitle: 'Рівні готовності пристрою',
      archLayersSubtitle: 'Що відкривається після підключення пристрою до DAARION',
      l1Title: 'Підключений пристрій',
      l1Subtitle: 'Безпечний вхід',
      l1Point1: 'Підготовка локального пристрою користувача',
      ...
      l2Title: 'Локальний агент',
      l2Subtitle: 'Можливості пристрою',
      ...
      installTitle: 'Підключити пристрій',
      installSubtitle: 'Підготуйте цей пристрій для локальних можливостей DAARION, приватних агентів і майбутніх режимів Worker Node, коли вони потрібні.',
      ...
      readyDesc: 'Підготуйте пристрій, створіть безпечну локальну ідентичність і продовжуйте координацію через MicroDAO.',
      downloadBtn: 'Підготувати пристрій',
      ...
      downloadInstaller: 'Завантажити нативний застосунок',
      openWebPwa: 'Відкрити налаштування пристрою',
      selectPlatformBelow: 'Оберіть спосіб підготовки пристрою нижче. GitHub repo доступний у футері для розробників.',
      fallbackVersionDesc: 'Якщо нативний застосунок ще не доступний для вашої платформи, використайте веб-налаштування пристрою.',
    ...
    pricingExtra: {
      ...
      sovereignFeature2: 'Власна інфраструктура підключених пристроїв',
      ...
      sovereignFeatureNew2: 'Модулі Device, Network та Governance',
    ...
    cryptoBilling: {
      ...
      verifyActionApprove: 'Схвалити вручну',
      verifyActionReject: 'Відхилити вручну',
  ...
  en: {
    ...
    onboarding: {
      ...
      errorLimitTitle: 'Early access temporarily limited',
      errorLimitDesc: 'Early access is temporarily limited. We are opening new spots gradually. Leave a request or try again later.',
    ...
    clientInstall: {
      ...
      archLayersTitle: 'Device readiness layers',
      archLayersSubtitle: 'What becomes available after connecting a device to DAARION',
      l1Title: 'Connected Device',
      l1Subtitle: 'Secure entry',
      l1Point1: 'Preparation of the user\'s local device',
      ...
      l2Title: 'Local Agent',
      l2Subtitle: 'Device capabilities',
      ...
      l3Title: 'Worker Node',
      l3Subtitle: 'Application-based mode',
      ...
      installTitle: 'Connect Device',
      installSubtitle: 'Prepare this device for DAARION local capabilities, private agents, and future Worker Node modes when needed.',
      ...
      readyDesc: 'Prepare your device, create a secure local identity, and continue coordinating through MicroDAO.',
      downloadBtn: 'Prepare device',
      returnToMicroDAO: 'Return to MicroDAO',
      footerCopyright: '— All rights reserved.',
      footerDesc: 'Built for agile coordination and living communities.',
      downloadInstaller: 'Download native app',
      openWebPwa: 'Open device setup',
      selectPlatformBelow: 'Select a device preparation option below. GitHub repo is available in the footer for developers.',
      fallbackVersionDesc: 'If the native app is not yet available for your platform, use device setup on web.',
    ...
    pricingExtra: {
      ...
      sovereignFeature2: 'Own connected-device infrastructure',
      ...
      sovereignFeatureNew2: 'Device, Network, and Governance modules',
    ...
    cryptoBilling: {
      ...
      verifyActionApprove: 'Approve manually',
      verifyActionReject: 'Reject manually',
  ...
  ru: {
    ...
    nav: {
      ...
      installClient: 'Подключить устройство',
      settings: 'Настройки',
      more: 'Ещё',
    ...
    landing: {
      ...
      whatIsMicroDAODesc: 'MicroDAO — это живая операционная система для небольших сообществ, построенная вокруг агентов искусственного интеллекта. Она интегрирует агентов памяти и координации с вашей базой знаний и задачами. Платформа поддерживает приватных агентов, будущий microDAO token layer и подключение устройств для локальных возможностей, когда они нужны.',
    ...
    onboarding: {
      ...
      errorLimitTitle: 'Ранний доступ временно ограничен',
      errorLimitDesc: 'Ранний доступ временно ограничен. Мы открываем новые места постепенно. Оставьте заявку или попробуйте позже.',
    ...
    clientInstall: {
      ...
      sideload: 'Sideload',
      comingSoon: 'Скоро',
      archLayersTitle: 'Уровни готовности устройства',
      archLayersSubtitle: 'Что становится доступным после подключения устройства к DAARION',
      l1Title: 'Подключенное устройство',
      l1Subtitle: 'Безопасный вход',
      l1Point1: 'Подготовка локального устройства пользователя',
      ...
      l2Title: 'Локальный агент',
      l2Subtitle: 'Возможности устройства',
      ...
      installTitle: 'Подключить устройство',
      installSubtitle: 'Подготовьте это устройство для локальных возможностей DAARION, приватных агентов и будущих режимов Worker Node, когда они нужны.',
      ...
      readyDesc: 'Подготовьте устройство, создайте безопасную локальную идентичность и продолжайте координацию через MicroDAO.',
      downloadBtn: 'Подготовить устройство',
      ...
      downloadInstaller: 'Скачать нативное приложение',
      openWebPwa: 'Открыть настройку устройства',
      selectPlatformBelow: 'Выберите способ подготовки устройства ниже. GitHub репозиторий доступен в футере для разработчиков.',
      fallbackVersionDesc: 'Если нативное приложение еще не доступно для вашей платформы, используйте веб-настройку устройства.',
    ...
    pricingExtra: {
      ...
      sovereignFeature2: 'Собственная инфраструктура подключенных устройств',
      ...
      sovereignFeatureNew2: 'Модули Device, Network и Governance',
    ...
    cryptoBilling: {
      ...
      verifyActionApprove: 'Одобрить вручную',
      verifyActionReject: 'Отклонить вручную',
  ...
  es: {
    ...
    nav: {
      ...
      installClient: 'Conectar dispositivo',
    ...
    landing: {
      ...
      whatIsMicroDAODesc: 'MicroDAO es un sistema operativo vivo para pequeñas comunidades construido alrededor de agentes de IA. Integra agentes de memoria y coordinación con sus tareas y base de conocimientos. Admite agentes privados, una futura capa de token microDAO y conexión de dispositivos para capacidades locales cuando sean necesarias.',
    ...
    onboarding: {
      ...
      errorLimitTitle: 'Acceso anticipado limitado temporalmente',
      errorLimitDesc: 'El acceso anticipado está limitado temporalmente. Abrimos nuevos cupos gradualmente. Deja una solicitud o inténtalo más tarde.',
    ...
    clientInstall: {
      ...
      archLayersTitle: 'Capas de preparación del dispositivo',
      archLayersSubtitle: 'Qué queda disponible después de conectar un dispositivo a DAARION',
      l1Title: 'Dispositivo conectado',
      l1Subtitle: 'Entrada segura',
      l1Point1: 'Preparación del dispositivo local del usuario',
      ...
      l2Title: 'Agente local',
      l2Subtitle: 'Capacidades del dispositivo',
      ...
      installTitle: 'Conectar dispositivo',
      installSubtitle: 'Prepare este dispositivo para capacidades locales de DAARION, agentes privados y futuros modos Worker Node cuando sean necesarios.',
      ...
      readyDesc: 'Prepare su dispositivo, cree una identidad local segura y continúe coordinando a través de MicroDAO.',
      downloadBtn: 'Preparar dispositivo',
      returnToMicroDAO: 'Volver a MicroDAO',
      footerCopyright: '— Todos los derechos reservados.',
      footerDesc: 'Construido para la coordinación ágil y comunidades vivas.',
      downloadInstaller: 'Descargar app nativa',
      openWebPwa: 'Abrir configuración del dispositivo',
      selectPlatformBelow: 'Seleccione una opción de preparación del dispositivo a continuación. El repositorio de GitHub está disponible en el pie de página para desarrolladores.',
      fallbackVersionDesc: 'Si la app nativa aún no está disponible para su plataforma, use la configuración web del dispositivo.',
    ...
    pricingExtra: {
      ...
      sovereignFeature2: 'Infraestructura propia de dispositivos conectados',
      ...
      sovereignFeatureNew2: 'Módulos Device, Network y Governance',
    ...
    cryptoBilling: {
      ...
      verifyActionApprove: 'Aprobar manualmente',
      verifyActionReject: 'Rechazar manualmente',
