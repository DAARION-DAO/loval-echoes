...
export const translations: Record<Language, Translations> = {
  uk: {
    ...
    pricingExtra: {
      ...
      subtitle: 'Оберіть свій рівень доступу',
      desc: 'Всі можливості спільної пам\'яті, чатів, завдань та ШІ-агентів екосистеми MicroDAO. Без прихованих платежів під час тестування.',
      testing: 'Тестування',
      ...
      earlyAccessFeature1: '1 простір після схвалення',
      earlyAccessFeature2: 'Базовий ШІ-агент (Steward Agent)',
      earlyAccessFeature3: 'Спільні чати та обговорення',
      earlyAccessFeature4: 'Дошка завдань та координація',
      earlyAccessFeature5: 'База знань (RAG до 50 МБ документів)',
      communityFeature1: 'Кілька робочих просторів (до 3)',
      communityFeature2: 'Розширена пам\'ять RAG (до 1 ГБ)',
      communityFeature3: 'До 3 ШІ-агентів одночасно',
      communityFeature4: 'Кастомні промпти та версіонування',
      communityFeature5: 'Пріоритетне оновлення бази знань',
      ...
      founderFeature4: 'Кастомна розробка додаткових агентів',
      founderFeature5: 'Пріоритетна підтримка у Telegram',
      sovereignFeature1: 'Повний суверенітет даних (On-premise)',
      sovereignFeature2: 'Власні приватні ШІ-агенти',
      sovereignFeature3: 'Запуск локальних L1/L2 моделей',
      sovereignFeature4: 'microDAO token layer в roadmap',
      sovereignFeature5: 'Розгортання через Edge Client',
  ...
  en: {
    ...
    pricingExtra: {
      ...
      desc: 'All capabilities of shared memory, chats, tasks, and AI agents of the MicroDAO ecosystem. No hidden fees during beta testing.',
      testing: 'Testing',
      scaling: 'Scaling',
      ...
      earlyAccessFeature1: '1 workspace after approval',
      earlyAccessFeature2: 'Basic AI agent (Steward Agent)',
      earlyAccessFeature3: 'Shared chats and discussions',
      earlyAccessFeature4: 'Task board and coordination',
      earlyAccessFeature5: 'Knowledge base (RAG up to 50 MB of documents)',
      communityFeature1: 'Multiple workspaces (up to 3)',
      communityFeature2: 'Extended RAG memory (up to 1 GB)',
      communityFeature3: 'Up to 3 AI agents simultaneously',
      communityFeature4: 'Custom prompts and versioning',
      communityFeature5: 'Priority knowledge base updates',
      founderFeature1: 'Priority bypass of the waitlist',
      founderFeature2: 'Early access to experimental features',
      founderFeature3: 'Participation in MicroDAO decisions',
      founderFeature4: 'Custom development of additional agents',
      founderFeature5: 'Priority support in Telegram',
      sovereignFeature1: 'Full data sovereignty (On-premise)',
      sovereignFeature2: 'Custom private AI agents',
      sovereignFeature3: 'Running local L1/L2 models',
      sovereignFeature4: 'microDAO token layer on the roadmap',
      sovereignFeature5: 'Deployment via Edge Client',
      applyBtn: 'Apply',
  ...
  ru: {
    ...
    pricingExtra: {
      ...
      subtitle: 'Выберите ваш уровень доступа',
      desc: 'Все возможности общей памяти, чатов, задач и ИИ-агентов экосистемы MicroDAO. Без скрытых платежей во время тестирования.',
      ...
      earlyAccessFeature1: '1 пространство после одобрения',
      earlyAccessFeature2: 'Базовый ИИ-агент (Steward Agent)',
      earlyAccessFeature3: 'Общие чаты и обсуждения',
      earlyAccessFeature4: 'Доска задач и координация',
      earlyAccessFeature5: 'База знаний (RAG до 50 МБ документов)',
      communityFeature1: 'Несколько рабочих пространств (до 3)',
      communityFeature2: 'Расширенная память RAG (до 1 ГБ)',
      communityFeature3: 'До 3 ИИ-агентов одновременно',
      communityFeature4: 'Кастомные промпты и версионирование',
      communityFeature5: 'Приоритетное обновление базы знаний',
      ...
      founderFeature4: 'Кастомная разработка дополнительных агентов',
      founderFeature5: 'Приоритетная поддержка в Telegram',
      sovereignFeature1: 'Полный суверенитет данных (On-premise)',
      sovereignFeature2: 'Собственные приватные ИИ-агенты',
      sovereignFeature3: 'Запуск локальных L1/L2 моделей',
      sovereignFeature4: 'microDAO token layer в roadmap',
      sovereignFeature5: 'Развертывание через Edge Client',
  ...
  es: {
    ...
    pricingExtra: {
      ...
      subtitle: 'Elija su nivel de acceso',
      desc: 'Todas las capacidades de memoria compartida, chats, tareas y agentes de IA del ecosistema MicroDAO. Sin tarifas ocultas durante las pruebas beta.',
      testing: 'Pruebas',
      scaling: 'Escalado',
      ...
      earlyAccessFeature1: '1 espacio de trabajo tras aprobación',
      earlyAccessFeature2: 'Agente de IA básico (Steward Agent)',
      earlyAccessFeature3: 'Chats y discusiones compartidos',
      earlyAccessFeature4: 'Tablero de tareas y coordinación',
      earlyAccessFeature5: 'Base de conocimientos (RAG hasta 50 MB de documentos)',
      communityFeature1: 'Múltiples espacios de trabajo (hasta 3)',
      communityFeature2: 'Memoria RAG ampliada (hasta 1 GB)',
      communityFeature3: 'Hasta 3 agentes de IA simultáneamente',
      communityFeature4: 'Prompts personalizados y control de versiones',
      communityFeature5: 'Actualizaciones de base de conocimientos prioritarias',
      founderFeature1: 'Bypass prioritario de la lista de espera',
      founderFeature2: 'Acceso temprano a funciones experimentales',
      founderFeature3: 'Participación en las decisiones de MicroDAO',
      founderFeature4: 'Desarrollo personalizado de agentes adicionales',
      founderFeature5: 'Soporte prioritario en Telegram',
      sovereignFeature1: 'Soberanía de datos completa (On-premise)',
      sovereignFeature2: 'Agentes de IA privados personalizados',
      sovereignFeature3: 'Ejecución de modelos locales L1/L2',
      sovereignFeature4: 'Capa de token microDAO en la hoja de ruta',
      sovereignFeature5: 'Despliegue a través de Edge Client',
      applyBtn: 'Solicitar',
