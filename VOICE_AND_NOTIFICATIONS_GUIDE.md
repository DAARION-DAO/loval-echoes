...
### Начало встречи
1. Перейдите на страницу `/chats`
2. Нажмите кнопку "Начать встречу"
3. Разрешите доступ к микрофону

### Управление звонком
- **Выключить микрофон**: Отключает ваш микрофон
- **Включить/выключить динамик**: Управление звуком от других участников
- **Завершить звонок**: Выход из голосового канала

### Технические детали
- **App ID**: YAROMIR (Agora Console)
- **Канал**: community-voice
- **Кодек**: VP8
- **Режим**: RTC (Real-Time Communication)
...
1. При первом входе система запросит разрешение на уведомления
2. Нажмите "Разрешить" в браузере
3. Уведомления автоматически подпишутся на все устройства
...
- Agora SDK: Chrome 58+, Firefox 56+
